...
example1_plot <- cbind(observed = afpca.output$Y[,1], reconstructed = afpca.output$Y_hat[,1]) %>%
                    ...
                    ggplot(aes(x = time, y = value)) +
                      ...
                      scale_color_manual(values = c("red","black"), name = "Type") + ylim(-.6, 1)
...
The vignette source files are available locally within the package directory at `./vignettes/articles/`. They can also be viewed online via the package's documentation site:

- [Reproducibility Vignette – Real Data Analysis](http://angelgarciadelagarza.com/afpca/articles/reproducibility_real_data.html)

- [Reproducibility Vignette – Simulations](<http://angelgarciadelagarza.com/afpca/articles/reproducibility_simulations.html>
