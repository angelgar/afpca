...
[![Codecov test
coverage](https://codecov.io/gh/angelgar/afpca/graph/badge.svg)](https://app.codecov.io/gh/angelgar/afpca)
...
$Y_i(t)$, $i = 1,\dots,20$ observed over 200 time points on a common
grid over domain (0,1) with gaussian noise. These functions are
...
- $\phi_k(t) = t^{-3/2}$
  $\sin(4\pi \times k \times t^{1/4})I(t>1/2), k = 1,2$
...
<img src="man/figures/README-simulated_data_plot-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="man/figures/README-estimated_fpc_plot-1.png" alt="" style="display: block; margin: auto;" />
